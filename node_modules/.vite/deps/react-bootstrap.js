...
function getReactVersion() {
  const parts = React80.version.split(".");
  return {
    major: +parts[0],
    minor: +parts[1],
    patch: +parts[2]
...
function useRTGTransitionProps(_ref) {
  ...
  const nodeRef = (0, import_react37.useRef)(null);
  ...
  const handleEnter = (0, import_react37.useCallback)(normalize(onEnter), [onEnter]);
  const handleEntering = (0, import_react37.useCallback)(normalize(onEntering), [onEntering]);
  const handleEntered = (0, import_react37.useCallback)(normalize(onEntered), [onEntered]);
  const handleExit = (0, import_react37.useCallback)(normalize(onExit), [onExit]);
  const handleExiting = (0, import_react37.useCallback)(normalize(onExiting), [onExiting]);
  const handleExited = (0, import_react37.useCallback)(normalize(onExited), [onExited]);
  const handleAddEndListener = (0, import_react37.useCallback)(normalize(addEndListener), [addEndListener]);
  return Object.assign({}, props, {
    ...
    ) : (0, import_react37.cloneElement)(children, {
      ref: mergedRef
    })
  });
}
...
var RTGTransition = React81.forwardRef((_ref, ref) => {
  ...
  return (0, import_jsx_runtime76.jsx)(Component2, Object.assign({
    ref
  }, transitionProps));
});
...
function useTransition({
  ...
  const isInitialRef = (0, import_react38.useRef)(true);
...
function ImperativeTransition({
  ...
  const [exited, setExited] = (0, import_react38.useState)(!inProp);
  if (inProp && exited) {
    setExited(false);
  }
  ...
  const combinedRef = useMergedRefs_default(ref, children.ref);
  return exited && !inProp ? null : (0, import_react38.cloneElement)(children, {
    ref: combinedRef
  });
}
function renderTransition(component, runTransition, props) {
  if (component) {
    return (0, import_jsx_runtime77.jsx)(RTGTransition_default, Object.assign({}, props, {
      component
    }));
  }
  if (runTransition) {
    return (0, import_jsx_runtime77.jsx)(ImperativeTransition, Object.assign({}, props, {
      transition: runTransition
    }));
  }
  return (0, import_jsx_runtime77.jsx)(NoopTransition_default, Object.assign({}, props));
}
...
function useModalManager(provided) {
  ...
  const modal = (0, import_react39.useRef)({
    dialog: null,
    backdrop: null
  });
  return Object.assign(modal.current, {
    ...
    setDialogRef: (0, import_react39.useCallback)((ref) => {
      modal.current.dialog = ref;
    }, []),
    setBackdropRef: (0, import_react39.useCallback)((ref) => {
      modal.current.backdrop = ref;
    }, [])
  });
}
var Modal = (0, import_react39.forwardRef)((_ref, ref) => {
  let {
    show = false,
    role = "dialog",
    className,
  ...
  const [exited, setExited] = (0, import_react39.useState)(!show);
  const lastFocusRef = (0, import_react39.useRef)(null);
  (0, import_react39.useImperativeHandle)(ref, () => modal, [modal]);
  ...
  const removeFocusListenerRef = (0, import_react39.useRef)();
  const removeKeydownListenerRef = (0, import_react39.useRef)();
...
var AbstractModalHeader = React88.forwardRef(({
  ...
  const context6 = (0, import_react40.useContext)(ModalContext_default);
...
var Modal2 = React91.forwardRef(({
  ...
  const renderBackdrop = (0, import_react41.useCallback)((backdropProps) => (0, import_jsx_runtime88.jsx)("div", {
    ...backdropProps,
...
var Offcanvas = React102.forwardRef(({
  ...
  const renderBackdrop = (0, import_react47.useCallback)((backdropProps) => (0, import_jsx_runtime99.jsx)("div", {
    ...backdropProps,
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime116.jsxs)(import_jsx_runtime115.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react54.cloneElement)(children, triggerProps), (0, import_jsx_runtime114.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var SplitButton = React123.forwardRef(({
  ...
  flip: flip2,
  ...props
}, ref) => (0, import_jsx_runtime127.jsxs)(Dropdown_default2, {
  ref,
  ...props,
  as: ButtonGroup_default,
  children: [(0, import_jsx_runtime126.jsx)(Button_default2, {
    size: size2,
    variant,
    ...
    type,
    children: title
  }), (0, import_jsx_runtime126.jsx)(Dropdown_default2.Toggle, {
    split: true,
    id,
    size: size2,
    variant,
  ...
  }), (0, import_jsx_runtime126.jsx)(Dropdown_default2.Menu, {
    role: menuRole,
    renderOnMount: renderMenuOnMount,
    rootCloseEvent,
    flip: flip2,
...
function useTabPanel(_ref) {
  ...
  const context6 = (0, import_react56.useContext)(TabContext_default);
  if (!context6)
    return [Object.assign({}, props, {
      role
    }), {
    ...
    return (0, import_jsx_runtime129.jsx)(TabContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime129.jsx)(SelectableContext_default.Provider, {
        ...
        children: (0, import_jsx_runtime129.jsx)(Transition, {
          ...
          mountOnEnter,
          unmountOnExit,
          children: (0, import_jsx_runtime129.jsx)(Component2, Object.assign({}, tabPanelProps, {
            ref,
            hidden: !isActive,
...
var TabContainer = ({
  transition,
  ...props
}) => (0, import_jsx_runtime131.jsx)(Tabs_default, {
  ...props,
  ...
  return (0, import_jsx_runtime133.jsx)(TabContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime133.jsx)(SelectableContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime133.jsx)(Transition, {
        ...
        mountOnEnter,
        unmountOnExit,
        children: (0, import_jsx_runtime133.jsx)(Component2, {
          ...rest,
          ref,
...
var Table = React130.forwardRef(({
  ...
  const table = (0, import_jsx_runtime134.jsx)("table", {
    ...props,
    className: classes,
    ref
  });
  if (responsive) {
    ...
    return (0, import_jsx_runtime134.jsx)("div", {
...
function renderTab(child) {
  ...
  return (0, import_jsx_runtime135.jsx)(NavItem_default2, {
    as: "li",
    role: "presentation",
    children: (0, import_jsx_runtime135.jsx)(NavLink_default, {
      as: "button",
      type: "button",
      eventKey,
      disabled,
...
var Tabs2 = (props) => {
  ...
  return (0, import_jsx_runtime136.jsxs)(Tabs_default, {
    id,
    activeKey,
    onSelect,
    transition: getTabTransitionComponent(transition),
    mountOnEnter,
    unmountOnExit,
    children: [(0, import_jsx_runtime135.jsx)(Nav_default2, {
      id,
      ...controlledProps,
      role: "tablist",
      as: "ul",
    ...
    }), (0, import_jsx_runtime135.jsx)(TabContent_default, {
      children: map(children, (child) => {
        ...
        return (0, import_jsx_runtime135.jsx)(TabPane_default, {
          ...childProps
        });
      })
    })]
...
var ToastFade = React132.forwardRef((props, ref) => (0, import_jsx_runtime137.jsx)(Fade_default, {
  ...props,
  ref,
...
var ToastHeader = React134.forwardRef(({
  ...
  const context6 = (0, import_react58.useContext)(ToastContext_default);
  const handleClick = useEventCallback((e) => {
    context6 == null ? void 0 : context6.onClose == null ? void 0 : context6.onClose(e);
  });
  return (0, import_jsx_runtime139.jsxs)("div", {
    ref,
    ...props,
    className: (0, import_classnames95.default)(bsPrefix, className),
    children: [children, closeButton && (0, import_jsx_runtime138.jsx)(CloseButton_default, {
      "aria-label": closeLabel,
      variant: closeVariant,
      onClick: handleClick,
      "data-dismiss": "toast"
...
var Toast = React136.forwardRef(({
  ...
  const toast = (0, import_jsx_runtime141.jsx)("div", {
    ...props,
    ref,
  ...
  return (0, import_jsx_runtime141.jsx)(ToastContext_default.Provider, {
    value: toastContext,
    children: hasAnimation && Transition ? (0, import_jsx_runtime141.jsx)(Transition, {
      in: show,
      onEnter,
      onEntering,
      onEntered,
...
var ToggleButton = React138.forwardRef(({
  ...
  return (0, import_jsx_runtime145.jsxs)(import_jsx_runtime144.Fragment, {
    children: [(0, import_jsx_runtime143.jsx)("input", {
      className: bsPrefix,
      name,
      type,
      value,
      ...
      id
    }), (0, import_jsx_runtime143.jsx)(Button_default2, {
      ...props,
      ref,
...
var ToggleButtonGroup = React139.forwardRef((props, ref) => {
  ...
  return (0, import_jsx_runtime146.jsx)(ButtonGroup_default, {
    ...controlledProps,
    ref,
    vertical,
    children: map(children, (child) => {
