...
function NewProductDetails() {
  ...
  // ✅ Static product images array
  const staticProductImages = [
    "/assets/Images/products/zoom/capZyme.png",
    "/assets/Images/products/zoom/cranpure.png",
    "/assets/Images/products/zoom/joshanda.png",
    "/assets/Images/products/zoom/plantcal.png",
  ];

  // 🔄 Commented out dynamic product images logic
  /*
  ...
  */
  ...
  // ✅ Use static array
  const productImages = staticProductImages;
  ...
  const supplementalFactsHTML = `
  <h4 style="margin-bottom: 15px;"><strong>Supplemental Facts:</strong></h4>
  <p>Each softgel contains:</p>
  <ul>
    <li>Vitamin D (as D3 Cholecalciferol): 10000 IU</li>
  </ul>
  <h4 style="margin-top: 20px;"><strong>How to Use:</strong></h4>
  <p>Take 2 capsules by mouth once daily with food.</p>
  <p><strong>BEST taken WITH FOOD</strong> for the following reason:</p>
  <ul>
    <li>Contains Vitamins A, E, lycopene and zexanthin which are fat soluble vitamins and fat soluble means they absorb better with food.</li>
    <li>And do not worry, the other 2 essential fat-soluble vitamins are D and K and they are found in our LiveGood D3/K2!</li>
  </ul>
  <p><strong>BEST taken in the morning</strong> since it contains Methylcobalamin (active form of B-12) which may provide a boost of energy and we do not want to negatively impact your sleep!</p>
  <p><strong>BEST taken EVERYDAY</strong> because many of these important vitamins and minerals must reach a steady state concentration in the body which means it takes time to establish a balance.</p>
  <p><strong>This is a HALAL product</strong></p>
  <p>Food supplements should not be used as a substitute for a varied and balanced diet and healthy lifestyle. No medical claims are made or implied for any product and these are sold as Nutritional/ Dietary supplements. Use as suggested or as advised by health care provider.</p>
  <h4 style="margin-top: 20px;"><strong>Our Quality Promise</strong></h4>
  <p>If you care this much about what goes in your body then we believe it should be the best quality. We go the extra step to ensure our vitamins and supplements are USP verified.</p>
  <p>Our dedication to quality, consistency and scientific research has resulted in vitamins and nutritional supplements of unrivaled excellence. By combining the latest breakthroughs in nutritional science with the finest ingredients, we’re proud to provide you with supplements of unsurpassed quality and value.</p>
  <p>Herbiotics supplements are overseen by our manufacturing specialists and quality experts, each one dedicated to maintaining the highest quality standards. As part of our commitment to quality, we only use ingredients from suppliers that meet our stringent Quality Assurance Standards, as well as GMP supplement quality standards.No Side Effects.</p>
`;
  ...
  return (
    <Layout>
      <main className="main">
          ...
          <div className="product-single-container product-single-default">
            <div className="row">
              ...
              <div className="col-lg-6 col-md-6 product-single-gallery">
                <div
                  className="product-main-image d-flex justify-content-center mb-2"
        ...
        <div
          className="supplemental-facts container mb-4 mt-4"
          dangerouslySetInnerHTML={{ __html: supplementalFactsHTML }}
        />
