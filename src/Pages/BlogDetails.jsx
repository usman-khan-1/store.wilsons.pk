                ...
                <div className="post-body">
                  ...
                  <div className="post-content">
                    <p>
                      ...
                      Cras non placerat mi. Etiam non tellus sem. Aenean pretium
                      convallis lorem, sit amet dapibus ante mollis a. Integer
                      bibendum interdum sem, eget volutpat purus pulvinar in.
                      Sed tristique augue vitae sagittis porta. Phasellus
                      ullamcorper, dolor suscipit mattis viverra, sapien elit
                      condimentum odio, ut imperdiet nisi risus sit amet ante.
                      Sed sem lorem, laoreet et facilisis quis, tincidunt non
                      lorem. Etiam tempus, dolor in sollicitudin faucibus, sem
                      massa accumsan erat.
                    </p>
                    ...
                    <h3>
                      ...
                      evolved over sometimes by accident, sometimes on purpose ”
                    </h3>

                    <p>
                      Aenean lorem diam, venenatis nec venenatis id, adipiscing
                      ac massa. Nam vel dui eget justo dictum pretium a rhoncus
...
>>>>>>> d01680c20b163a66ff54f3a032bc8458390afb17
                    </div>
                </nav>
                    ...
                    <div className="row">
                        <div className="col-lg-9">
                            ...
                            <div className="related-posts">
                                ...
                                <div
                                    className="owl-carousel owl-theme related-posts-carousel"
                                    data-owl-options="{
								'dots': false
							}"
                                >
                                    <article className="post">
                                        ...
                                        <div className="post-body">
                                            ...
                                            <h2 className="post-title">
                                                <Link to={"/blog-details"}>Post Format - Image</Link>
                                            </h2>
                                    ...
                                    <ul className="simple-post-list">
                                        <li>
                                            ...
                                            <div className="post-info">
                                                <Link to={"/blog-details"}>Post Format - Video</Link>
