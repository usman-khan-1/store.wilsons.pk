...
//         formData.append(`basic_info[${key}]`, formData[key]);
//       });

//       // Append product details
//       productDetail.forEach((product, index) => {
//         Object.keys(product).forEach((key) => {
//           formData.append(`product_detail[${index}][${key}]`, product[key]);
//         });
//       });

//       // Append payment details
//       Object.keys(paymentDetails).forEach((key) => {
//         formData.append(`payment[${key}]`, paymentDetails[key]);
//       });

//       // Append RX prescription if it exists
//       if (hasRxItems && rxPrescription) {
//         formData.append("rx_prescription", rxPrescription);
//       }

//       const orderResponse = await makePostRequest("orders/add", formData, {
//         headers: {
...
//                 <table className="table table-mini-c